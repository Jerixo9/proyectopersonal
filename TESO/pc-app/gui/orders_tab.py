...
class OrdersTab(ctk.CTkFrame):
    def __init__(self, master, **kwargs):
        ...
        try:
            ...
            self.img_primary_prep = load_img("btn_primary_prep.png", 160, 32)
            self.img_primary_send = load_img("btn_primary_send.png", 160, 32)
    ...
    def _build_ui(self):
        ...
        # Configurar 1 columna (1 pedido por fila)
        self.scroll_orders.grid_columnconfigure(0, weight=1)
    ...
    def _render_order_card(self, order: dict, index: int):
        ...
        card.grid(row=index, column=0, sticky="nsew", padx=10, pady=10)
        ...
        body_frame.pack(fill="both", expand=True, padx=15, pady=0)
        ...
        actions_row.pack(fill="x", padx=15, pady=(5, 15))
        ...
        if st == "Pendiente":
            ...
            btn_prep.pack(side="left", padx=(0, 10))
            ...
            btn_reopen.pack(side="left", padx=(0, 10))
